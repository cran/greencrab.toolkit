...
#include "stanExports_greencrabtools_traptypes.h"

RCPP_MODULE(stan_fit4greencrabtools_traptypes_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_greencrabtools_traptypes")
