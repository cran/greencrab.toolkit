...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_greencrabtools_joint");
    reader.add_event(46, 44, "end", "model_greencrabtools_joint");
    return reader;
}
#include <stan_meta_header.hpp>
class model_greencrabtools_joint
  : public stan::model::model_base_crtp<model_greencrabtools_joint> {
private:
        int S;
        int C;
        std::vector<int> N;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= C; ++j) {
                ...
                lp_accum__.add(neg_binomial_2_log<propto__>(get_base1(E, j, "E", 1), stan::math::exp(log_mu), phi));
            }
    ...
    std::string model_name() const {
        return "model_greencrabtools_joint";
    }
...
typedef model_greencrabtools_joint_namespace::model_greencrabtools_joint stan_model;
#ifndef USING_R
